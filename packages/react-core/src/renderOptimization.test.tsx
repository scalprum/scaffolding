...
import { useGetState, useSubscribeStore } from './index';
...
describe('Shared Store Integration Tests - Render Optimization', () => {
  ...
  describe('Event-specific subscription render optimization', () => {
    let store: ReturnType<
      typeof createSharedStore<{ count: number; name: string; theme: string }, readonly ['UPDATE_COUNT', 'UPDATE_NAME', 'UPDATE_THEME']>
    >;
